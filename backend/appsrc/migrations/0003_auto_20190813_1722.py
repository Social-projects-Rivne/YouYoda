...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('appsrc', '0002_auto_20190808_1721'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='usr_stat_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appsrc.UserStatuses'),
        ),
        migrations.AddField(
            model_name='achievements',
            name='course_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appsrc.Courses'),
        ),
    ]
